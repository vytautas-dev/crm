...
- `npm run preview` — preview production build against Cloudflare adapter
...
See @README.md for local setup and deployment.

## CI

`.github/workflows/ci.yml` requires `SUPABASE_URL` and `SUPABASE_KEY` as repository secrets for the build step.
